...
# print("BFS done")
# #
# with open(f'Hanoi_PDB/hanoi_pdb_{num_disks_bfs}.txt', 'w') as convert_file:
...
#
# with open(f'Buckets/bucket_min_price 8.txt', "r") as file:
#     file_data = file.read()
...
#     file_data = file.read()
#     strong_hur8 = json.loads(file_data)
#
# with open(f'hanoi_database 8.txt', "r") as file:
#     file_data = file.read()
