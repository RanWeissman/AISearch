...
#     a_star = A_Star_Buckets(a_star_buckets[bucket], str(num_towers-1)*num_disks)
#     p = a_star.solve()
...
#
# with open(f'bucket_min_price {num_disks},{num_small_disk}.txt', 'w') as convert_file:
...
#
# with open(f'hanoi_database 6.txt', "r") as file:
#     fileData  = file.read()
#     database4 = json.loads(fileData)
#
# with open(f'bucket_min_price 8,2.txt', "r") as file:
#     fileData  = file.read()
#     bucket_min_price8 = json.loads(fileData)
#
# for config in database8.keys():
#     price_pdb6 = database4[config[num_small_disk:]][0]
#     strong_hur[config] = bucket_min_price8[str(price_pdb6)]
#
# with open(f'strong_hur 8,2.txt', 'w') as convert_file:
#      convert_file.write(json.dumps(strong_hur))
#
# ####################### checking admissablity ######################
# with open(f'strong_hur 8,2.txt', "r") as file:
#     fileData  = file.read()
