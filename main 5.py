...
with open(f'Hanoi_PDB/hanoi_pdb_{num_disks_bfs}_2_layer.txt', 'w') as convert_file:
...
with open(f'Compares/compare_bucket_min_price_{num_disks-num_small_disk}_{num_small_disk}_configless.txt', 'w') \
        as convert_file:
